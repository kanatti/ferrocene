...
/// Reads a fixed-length string from a Bytes buffer.
...
/// Reads fixed-length bytes from a Bytes buffer.
...
/// Reads a string from a Bytes buffer.
...
/// Reads a vint from a Bytes buffer.
...
/// Reads a HashSet<String> from a Bytes buffer.
...
/// Reads a Vec<String> from a Bytes buffer.
